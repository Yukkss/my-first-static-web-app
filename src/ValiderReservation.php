...
<html>
	...
	<body>
		...
		$index=ValiderReservation($conn1,$local_idreservation); // appel de la fonction enregistreClient ; on passe en paramètre le nom du client (ici dans une variable)

		// fermeture de la connexion a la base de donnees.
		deconnexionBDD($conn1);
		header( "refresh:2;url=afficheReservations.php" );
		?>
		Fin code de la modification de la reservation <?php echo $local_idreservation ?>
		<br />
