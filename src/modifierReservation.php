                ...
                <div class="card mt-4">
					...
					<Table class="table table-hover">
						...
						<?php
							...
							$resultat=AfficheReservationAModifier($conn1, $local_idreservation);
				...
				<div class="card-body">
					...
					<div class="col-md-4 mb-3">
						<div class="border p-2">
									<form method=""="GET" action="ModificationReservation.php">
									<p> Modifier la voiture associée à la réservation :</p>
								 <?php
								 $resulta=ShowAllCar($conn1);
								 $resuTab = $resulta->fetchAll(); // on récupère le tout dans un tableau. Dans le tableau résultat, la 1ère ligne est associée à chaque ligne qui suit.
									print '<select class="select" name="P_refidvoiture">'; // envoyé comme paramètre dans le formulaire
									foreach ($resuTab as $ligne) {
									print '<option value='.$ligne["idvoiture"].'>'.$ligne["idvoiture"].' - '.$ligne["nomvoiture"].'</option>';
									}
									print "</select>";
					...
					<div class="col-md-4 mb-3">
                         <div class="border p-2">
							<form method="GET" action="modifierReservation.php">
								<p> Modifier une autre resérvation :</p>
								 <?php
					...
					<div class="col-md-4 mb-3">
						...
						<p> Supprimer une autre resérvation :</p>
						 <?php
					 $resulta=AfficheReservation($conn1);
					 $resuTab = $resulta->fetchAll(); // on récupère le tout dans un tableau. Dans le tableau résultat, la 1ère ligne est associée à chaque ligne qui suit.
						print '<select class="select" name="P_refidreservation">'; // envoyé comme paramètre dans le formulaire
						...
						<form method="GET" action="validerReservation.php">
						<input type="hidden" name="P_refidreservation"  value=<?php echo $local_idreservation?>>
						<br> <input class="gros_bouton_bleu" type="submit" value="Valider la réservation"></br>
